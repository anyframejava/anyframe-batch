...
public abstract class AbstractItemReadWriter implements AnyframeItemReader, AnyframeItemWriter, ItemStream {

	private static final Log LOGGER = LogFactory.getLog(AbstractItemReadWriter.class);
