...
public interface AnyframeTasklet {

	ExitStatus doExecute(AnyframeItemReaderFactory readerFactory, AnyframeItemWriterFactory writerFactory,  AnyframeAbstractTasklet tasklet) throws Exception;
