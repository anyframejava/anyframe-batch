...
import com.sds.anyframe.batch.vo.reflector.NoSuchFieldRuntimeException;
import com.sds.anyframe.batch.vo.reflector.NoSuchMethodRuntimeException;
...
public class PojoReflector implements Reflector {
	...
	public boolean isSupportedDataType(Object obj, String type, Charset charset) {
		return false;
	}
