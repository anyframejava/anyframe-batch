...
import com.sds.anyframe.batch.annotation.Scale;
...
public class FieldMeta {
	...
	public static FieldMeta valueOf(Field field, int depth, Stack<StackItem> parents) {
		...
		if (length != null) {
			...
			fieldMeta.length = fieldMeta.fieldLength;
		}
		...
		} else if (fieldMeta.fieldType == FieldType.VO) {
	...
	private static void calculateFieldLength(ArraySize arraySize, FieldMeta fieldMeta) {
		...
		if (arraySize != null && !arraySize.variable()) {
			if (fieldMeta.voMeta != null) {
				...
				fieldMeta.fieldCount = fieldMeta.arraySize;
				fieldMeta.length     = fieldMeta.fieldLength * fieldMeta.arraySize;
			}
			
		} else {
			fieldMeta.fieldCount = 0;
			fieldMeta.length = 0;
		}
	}
	...
	public Object fromString(String value) {
		Object obj = getFieldType().fromString(value);
	...
	public String toString(Object value) {
		...
		return getFieldType().toString(value);
	}
