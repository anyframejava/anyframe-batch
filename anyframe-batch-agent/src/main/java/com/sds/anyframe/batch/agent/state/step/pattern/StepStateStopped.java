 ...
 */
public class StepStateStopped extends AbstractStepState {

	public StepStateStopped() {
		super(STATES.STOPPED);
	}

	@Override
	public Step startStep(Step step) throws Exception {
		throw new UnsupportedOperationException(StepStateStopped.class
				.getName()
	...
	public void failStep(Step step) {
		throw new UnsupportedOperationException(StepStateStopped.class.getName()
				+ " do not support this operaton[" + AgentUtils.toStepString(step) + "]");
	}
