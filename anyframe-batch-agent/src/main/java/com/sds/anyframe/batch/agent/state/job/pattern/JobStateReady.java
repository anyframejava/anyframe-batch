 ...
 */
public class JobStateReady extends AbstractJobState {

	private final Logger log = Logger.getLogger(getClass());

	public JobStateReady() {
		super(STATES.READY);
	}
	@Override
	public Job startJob(Job job) throws Exception {
		throw new UnsupportedOperationException(JobStateReady.class.getName()
	...
	public void jobExecuted(Job job) throws Exception {
		...
		jobDao.updateJobAsRunning(job.getJobSeq());
		log.info("Job Status(RUNNING) - " + AgentUtils.toJobString(job));
	}
