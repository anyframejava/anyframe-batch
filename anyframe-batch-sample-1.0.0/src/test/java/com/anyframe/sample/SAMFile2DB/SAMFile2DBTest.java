...
public class SAMFile2DBTest {
	...
	public void run() {
		...
		int ret = launcher.execute(new String[]{"classpath:com/anyframe/sample/SAMFile2DB/SAMFile2DB_CFG.xml"});
//		launcher.execute(new String[]{"classpath:com/anyframe/sample/SAMFile2DB/SAMFile2DB_CFG.xml","step=createDataWithoutVo"});
