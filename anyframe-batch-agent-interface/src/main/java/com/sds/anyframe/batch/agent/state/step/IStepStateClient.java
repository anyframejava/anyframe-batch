...
public interface IStepStateClient {

	public static final String SERVICE_NAME = "stepStateClient";
	
	Step startStep(Step step) throws Exception;

	void stepExecuted(Step step) throws Exception;
	
	void completeStep(Step step) throws Exception;
	
	void failStep(Step step) throws Exception;

	void updatePerformanceAndTransactedCount(Performance performance, Step currentStep);
